    ...
    class kardex{
        ...
        public function getKardexs(){
         ...
         public function getKardex(){
            $sqlQuery = "SELECT id, fecha, descripcion, ID_articulo, entradas, salidas, precio, saldo, estado FROM ". $this->db_table ." WHERE id = ? LIMIT 0,1";
            $stmt = $this->conn->prepare($sqlQuery);
        ...
        public function createKardex(){
            $sqlQuery = "INSERT INTO ". $this->db_table ." SET fecha = :fecha, descripcion = :descripcion, ID_articulo = :ID_articulo, entradas = :entradas, salidas = :salidas, precio = :precio, saldo = :saldo, estado = :estado";
            $stmt = $this->conn->prepare($sqlQuery);
        ...
        public function updateKardex(){
            $sqlQuery = "UPDATE ". $this->db_table ." SET fecha = :fecha, descripcion = :descripcion, ID_articulo = :ID_articulo, entradas = :entradas, salidas = :salidas, precio = :precio, saldo = :saldo, estado = :estado WHERE id = :id";
            $stmt = $this->conn->prepare($sqlQuery);
